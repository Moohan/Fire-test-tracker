                  ...
                  data?.logs.map((log) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-sm">
                        <span className="bg-slate-100 px-2 py-0.5 rounded text-slate-700 text-xs font-bold uppercase">
                          {log.type}
                        </span>
                      </td>
                      <td className="px-4 py-4 text-sm">
                        <span
                          className={`font-bold ${log.result === "PASS" ? "text-sfrs-green" : "text-sfrs-red"}`}
                        >
                          {log.result === "PASS" ? "✓ PASS" : "✗ FAIL"}
                        </span>
                      </td>
                      <td
                        className="px-4 py-4 text-sm text-slate-500 max-w-xs truncate"
                        title={log.notes || ""}
                      >
                        {log.notes || "-"}
                      </td>
