              ...
              <div key={item.id} className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden flex flex-col hover:border-slate-300 transition-colors">
                <div className="p-4 flex-1">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`flex-shrink-0 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${
                      isOtr
                        ? "bg-sfrs-red/10 text-sfrs-red border-sfrs-red/20"
                        : anyOutstanding
                          ? "bg-sfrs-amber/10 text-sfrs-amber border-sfrs-amber/20"
                          : "bg-sfrs-green/10 text-sfrs-green border-sfrs-green/20"
                    }`}>
                  ...
                  <div className="space-y-2 pt-3 border-t border-slate-100">
                    <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Compliance Requirements</h3>
                    <div className="grid grid-cols-1 gap-2">
                      {item.compliance.length > 0 ? item.compliance.map((c, idx) => (
                        <div key={idx} className="flex items-center justify-between bg-slate-50/50 p-1.5 rounded border border-slate-100">
                          ...
                          <div className={`w-2 h-2 rounded-full shadow-sm ${c.satisfied ? "bg-sfrs-green" : c.hasFail ? "bg-sfrs-red" : "bg-slate-300"}`}></div>
                        </div>
